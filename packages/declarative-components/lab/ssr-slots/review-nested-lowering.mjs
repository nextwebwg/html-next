...
const runtime = (await build({ entryPoints: ["/Users/matthew/git/oss/nextwebwg/html-next/packages/declarative-components/src/runtime.ts"], bundle: true, format: "iife", globalName: "HtmlRuntime", write: false, platform: "browser", logLevel: "error" })).outputFiles[0].text;
