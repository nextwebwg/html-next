...
const packageName = "@nextwebwg/declarative-components";
...
describe.skipIf(!enabled)("installed package consumer", () => {
  ...
  beforeAll(async () => {
    ...
    installedRoot = join(consumer, "node_modules", "@nextwebwg", "declarative-components");
  ...
  it("ships JavaScript and declarations for every public export", async () => {
    assert.equal(manifest.version, "1.0.0-alpha.1");
